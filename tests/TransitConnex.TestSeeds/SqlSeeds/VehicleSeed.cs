...
public class VehicleSeed
{
    public static readonly List<Vehicle> Vehicles = [
        new()
        {
            ...
            Capacity = 50,
            Icon = IconSeed.BusIcon,
            Label = "Trol 32",
            Manufacturer = "Avia",
            VehicleType = VehicleTypeEnum.BUS,
            Spz = "6B5-2007",
            IconId = IconSeed.BusIcon.Id,
        ...
        new()
        {
            ...
            Capacity = 100,
            Icon = IconSeed.TramIcon,
            Label = "Tram 1",
            Manufacturer = "Škoda",
            VehicleType = VehicleTypeEnum.TRAM,
            Spz = "1911",
            IconId = IconSeed.TramIcon.Id,
            Manufactured = DateTime.Parse("2021-09-01 00:00:00"),
    ...
    public static void Seed(AppDbContext context)
    {
        ...
        foreach (var vehicle in Vehicles.Where(x => x.VehicleType == VehicleTypeEnum.TRAIN))
        {
            vehicleServices.AddRange(
            [
                new VehicleOfferedService()
                {
                    VehicleId = vehicle.Id,
                    ServiceId = Guid.Parse("3d6fdad5-289d-46af-9333-87c89bfe49de")
                },
                new VehicleOfferedService()
                {
                    VehicleId = vehicle.Id,
                    ServiceId = Guid.Parse("87d8d30c-3c92-4d2e-96f2-703f373ae448")
                },
                new VehicleOfferedService()
                {
                    VehicleId = vehicle.Id,
                    ServiceId = Guid.Parse("8c015a66-aab3-489a-b143-b24dc7da2f0b")
                }
            ]);
        }
