...
{
    public class RouteSchedulingTemplateRepository : BaseRepository<RouteSchedulingTemplate, RouteSchedulingTemplateUpdateCommand>, IRouteSchedulingTemplateRepository
    {
