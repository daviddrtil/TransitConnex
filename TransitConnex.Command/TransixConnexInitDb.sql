...
CREATE TABLE Line ( -- TODO -> how do we deal with two routes being active ? for example route reckovice-hlavas and hlavas-reckovice -> or are those two separate lines?
    Id UNIQUEIDENTIFIER PRIMARY KEY,
