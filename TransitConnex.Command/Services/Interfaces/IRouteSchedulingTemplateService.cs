...
namespace TransitConnex.Infrastructure.Services.Interfaces
{
    public interface IRouteSchedulingTemplateService
    {
        ...
        Task<RouteSchedulingTemplateDto> CreateRouteSchedulingTemplate(RouteSchedulingTemplateCreateDto routeSchedulingTemplateDto);

        Task<RouteSchedulingTemplateDto> EditRouteSchedulingTemplate(Guid id, RouteSchedulingTemplateCreateDto editedRouteSchedulingTemplate);
